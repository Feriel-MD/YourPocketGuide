...
public class RecyclerviewActivitesMarseille extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new Item("Le palais Longchamp","Bd Jard. Zoologique,\n13004 Marseille","Téléphone : 04 91 55 25 51",R.drawable.longchamp));

        recyclerView7.setLayoutManager(new LinearLayoutManager(this));
        recyclerView7.setAdapter(new MyAdapter(getApplicationContext(),items,R.layout.item_view_activites_marseille));
    }
}