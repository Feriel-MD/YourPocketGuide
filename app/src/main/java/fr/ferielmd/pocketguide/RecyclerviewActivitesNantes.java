...
public class RecyclerviewActivitesNantes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new Item("Visite du Château des Ducs de Bretagne","4 Pl. Marc Elder,\n44000 Nantes","Téléphone : 02 51 17 49 48",R.drawable.chateau));
        items.add(new Item("Les Machines de l’île","2 Boulevard Léon Bureau,\n44200 Nantes","Téléphone : 08 10 12 12 25",R.drawable.machines));
        items.add(new Item("l’Estuaire","9 rue des Etats,\n44000 Nantes","Téléphone : 02 72 64 04 79",R.drawable.estuaire));
        items.add(new Item("Découverte du Planétarium","8 rue des Acadiens,\n44100 Nantes","Téléphone : 02 40 73 99 23",R.drawable.planetarium));
        items.add(new Item("Visite de la Cathédrale Saint-Pierre-et-Saint-Paul","7 Imp. Saint-Laurent,\n44000 Nantes","Téléphone : 02 40 47 84 64",R.drawable.cathedrale));


        recyclerView10.setLayoutManager(new LinearLayoutManager(this));
        recyclerView10.setAdapter(new MyAdapter(getApplicationContext(),items,R.layout.item_view_activites_nantes));
    }
}