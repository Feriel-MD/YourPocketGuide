...
public class RecyclerviewHebergemetsLyon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new Item5("Villa 216 ","216 Avenue Félix Faure,\n69003 Lyon","Téléphone : 07 86 58 02 03",R.drawable.villa));
        items.add(new Item5("Le Jardin de Beauvoir ","8 rue de Trion,\n69005 Lyon ","Téléphone : 06 03 67 27 84",R.drawable.jardin));
        items.add(new Item5("Bread et Couette ","12 Rue Louis Bouquet,\n69009 Lyon ","Téléphone : 07 68 85 23 55",R.drawable.bread));
        items.add(new Item5("L’Atelier de Saint-Just ","22 Rue de Trion,\n69005 Lyon ","Téléphone : 04 72 57 49 55 ",R.drawable.atelier));
        items.add(new Item5("LOGE DE L'OPERA","20 RUE JOSEPH SERLIN,\n69001 Lyon","Téléphone : 06 44 05 71 84",R.drawable.opera));
