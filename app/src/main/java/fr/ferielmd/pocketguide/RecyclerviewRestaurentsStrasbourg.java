...
public class RecyclerviewRestaurentsStrasbourg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new Item15("Enigmatic escape game Lyon","11 Rue de la Part-Dieu,\n69003 Lyon","Téléphone : 09 86 15 915 55",R.drawable.enigmatic));
        items.add(new Item15("Musée des Confluences","86 Quai Perrache,\n69002 Lyon","Téléphone : 015 28 38 15 15",R.drawable.confluence));
        items.add(new Item15("Patinoire Charlemagne","100 cours Charlemagne,\n69002 Lyon","Téléphone : 015 78 152 615 55",R.drawable.l_a_patinoire));
        items.add(new Item15("Musée Miniature et Cinéma","60 rue Saint Jean,\n69005 Lyon","Téléphone : 015 72 00 215 77",R.drawable.museeminiature));
        items.add(new Item15("Musée des Beaux-Arts de Lyon","20 Place des Terreaux,\n69001 Lyon","Téléphone : 015 72 10 17 150",R.drawable.beauxarts));
